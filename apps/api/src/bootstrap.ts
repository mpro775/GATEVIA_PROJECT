...
export function setupOpenApi(app: INestApplication) {
  const config = new DocumentBuilder().setTitle('GATEVIA API').setDescription('GATEVIA V1 public and administration REST API').setVersion('1.0.0').addCookieAuth('gatevia_session').build();

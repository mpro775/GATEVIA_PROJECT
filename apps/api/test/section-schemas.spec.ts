...
describe('controlled page sections', () => {
  it('contains the contract allowlist', () => expect(Object.keys(sectionSchemas).sort()).toEqual(['case_studies','cta','ecosystem','faq','form','hero','industries_grid','insights','logo_cloud','process','rich_text','services_grid','stats','testimonials','text_image','timeline'].sort()));
